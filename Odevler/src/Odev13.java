...
public String getSoyisim(String soyisim)
{
	return this.soyisim;
}
//Accessors vize1
public double setVize1(double vize1)
{
	this.vize1 = vize1;
}
public double getVize1(double vize1)
{
	return this.vize1;
}
//Accessors vize2
public double setVize2(double vize2)
{
	this.vize2 = vize2;
}
public double getVize2(double vize2)
{
	return this.vize2;
}
//Accessors donemSonu
public double setDonemSonu(double donemSonu)
{
	this.donemSonu = donemSonu;
}
public double getDonemSonu(double donemSonu)
{
	return this.donemSonu;
}
//Accessors finalNotu
public double setFinalNotu(double finalNotu)
{
	this.finalNotu = finalNotu;
}
public double getFinalNotu(double finalNotu)
{
	return this.finalNotu;
}
		...
		public static void ogrencileriYazdir(OgrenciSirala[] ogrenciler) {
			for (int i = 0; i < ogrenciler.length; i++) {
				System.out.println((i + 1) + ". ogrenci: " + ogrenciler[i].finalNotu + " notu ile " + ogrenciler[i].ID
						+ " nolu " + ogrenciler[i].isim + " " + ogrenciler[i].soyisim);
			}
		}
