...
public class Urun {
    ...
    double miktar;
    double alisFiyati;
    static File urunler = new File("C:\\Users\\Asus\\eclipse-workspace\\Odev1616\\src\\Source\\Urunler.txt");
    static File indirimler = new File("C:\\Users\\Asus\\eclipse-workspace\\Odev1616\\src\\Source\\IndirimSinifi.txt");
    ...
    public static void main(String[] args) {
        ...
        siparisVer("Sogan", 10, 100000);
        siparisVer("Lahana", 20, 100000);
        siparisVer("Sarimsak", 25, 100000);
