...
public class OnikiASinifi {
    public static final File notDefteri = new File("C:\\Users\\Asus\\eclipse-workspace\\NotDefterim\\src\\NotDefterim.txt");
    ...
    public static void harfNotuHesapla(String ogrenciNo) {
